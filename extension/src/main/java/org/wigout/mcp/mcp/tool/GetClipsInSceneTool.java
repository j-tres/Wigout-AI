            ...
            (exchange, req) -> McpErrorHandler.executeWithValidation(
                ...
                (arguments, operation) -> {
                    ...
                    if (sceneIndexObj == null && (sceneName == null || sceneName.trim().isEmpty())) {
                        throw new org.wigout.mcp.common.error.BitwigApiException(
                            org.wigout.mcp.common.error.ErrorCode.MISSING_REQUIRED_PARAMETER,
                            operation,
                    ...
                    if (sceneIndexObj != null) {
                        if (sceneIndexObj instanceof Number) {
                            ...
                            if (index < 0) {
                                throw new org.wigout.mcp.common.error.BitwigApiException(
                                    org.wigout.mcp.common.error.ErrorCode.INVALID_PARAMETER,
                                    operation,
                            ...
                            throw new org.wigout.mcp.common.error.BitwigApiException(
                                org.wigout.mcp.common.error.ErrorCode.INVALID_PARAMETER_TYPE,
                                operation,
